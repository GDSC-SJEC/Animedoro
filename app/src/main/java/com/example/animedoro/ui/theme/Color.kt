package com.example.animedoro.ui.theme
...
val primary = Color(0xFF484556)
val secondary = Color(0xFF2F2A42)
val cardTrans = Color(0xDF160C0C)
val taskbottom = Color(0x88FFFFFF)
